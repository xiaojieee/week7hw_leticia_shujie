...
# __add__ is used as an overloading operator or TypeError - unsupported opperand
...
# derives from overloaded methods greater than(__gt__), less than(__lt__)
...
# derives from overloading method
if lisa_account == bart_account:
...
print(marge_account._account_holder_name)
...
Account.set_bank_name("Bank of Leticia")
